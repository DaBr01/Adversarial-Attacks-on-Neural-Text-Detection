...
class FormalityDetailedExperiment(Experiment):
    def __init__(self):
        super().__init__(name="Formality detailed test", desc="Testing different essay formality levels by specifying "
...
experiment = FormalityDetailedExperiment()
experiment.detect()
